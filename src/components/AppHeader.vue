  ...
  <header class="tool-panel px-4 py-3">
    <div class="flex flex-col gap-3">
      <div class="flex flex-wrap items-center gap-3">
        ...
        <label class="floating-field min-w-[12rem]">
        ...
        <div class="truncate text-sm text-slate-400">{{ portLabel }}</div>
      </div>

      <div class="grid gap-3 xl:grid-cols-[repeat(4,minmax(0,1fr))_minmax(10rem,12rem)]">
